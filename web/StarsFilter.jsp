<%-- 
    Document   : StarsFilter
    Created on : Jan 12, 2021, 11:15:59 PM
    Author     : pc
--%>
...
<html>
    ...
    <body>
        <form class="center" action="StarsFilter.jsp" method="post">
          
            <label>Stars (4) OR (5):</label>
            <input class="input" type="text" name="stars" value="" required/>

            <input class="button1" type="submit" value="Done" required/>
        ...
        <%
            ...
            PreparedStatement checkStmt = (PreparedStatement) connection.prepareStatement("SELECT * FROM Hotels where Destination=? and HotelStars=?;");
            checkStmt.setString(1,destination);
            checkStmt.setString(2,stars);
