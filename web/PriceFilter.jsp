<%-- 
    ...
    Created on : Jan 12, 2021, 11:13:00 PM
    Author     : pc
--%>
...
<html>
    ...
    <body>
        <form class="center" action="PriceFilter.jsp" method="post">
          
            <label>Minimum price        :</label>
            <input type="number" class="input" name="minPrice" value="" required min="0" />
            
            <label >Maximum price      :</label>
            <input type="number" class="input" name="maxPrice" value="" required min="0" />
        ...
        <%
            ...
            PreparedStatement checkStmt = (PreparedStatement) connection.prepareStatement("SELECT * FROM Hotels where Destination=? and HotelExpectedPrice>=? and HotelExpectedPrice<=?;");
            checkStmt.setString(1,destination);
            checkStmt.setString(2,minPrice);
            checkStmt.setString(3,maxPrice);
