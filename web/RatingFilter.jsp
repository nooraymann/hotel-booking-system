...
<html>
    ...
    <body>
        <form class="center" action="RatingFilter.jsp" method="post">
          
            <label>Rating (*):</label>
            <input class="input" type="text" name="rating" value="" required />
        ...
        <%
            ...
            PreparedStatement checkStmt = (PreparedStatement) connection.prepareStatement("SELECT * FROM Hotels where Destination=? and HotelRating=?;");
            checkStmt.setString(1,destination);
            checkStmt.setString(2,rating);
