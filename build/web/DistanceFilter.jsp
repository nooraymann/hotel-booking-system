<%-- 
    Document   : DistanceFilter
    Created on : Jan 12, 2021, 11:16:55 PM
    Author     : pc
--%>
...
<html>
    ...
    <body>
       <form class="center" action="DistanceFilter.jsp" method="post">
          
            <label>Maximum distance:</label>
            <input class="input" type="number" name="distance" required min="0"  />
        ...
        <%
            ...
            PreparedStatement checkStmt = (PreparedStatement) connection.prepareStatement("SELECT * FROM Hotels where Destination=? and DistanceFromCityCenter<=?;");
            checkStmt.setString(1,destination);
            checkStmt.setString(2,distance);
